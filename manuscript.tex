...
Below we present a variety of toy model to explore the relationship between network shape and density and the calculated measure of network distinction. 

\subsubsection{Distinction and Brokerage: Structural Holes vs. Structural Folds}
...
\subsubsection{Circle Graphs and Triadic Closure Incentives}
Here be dragons.
...
%-Psychology
%-Balance version response triadic closure, Polarity, valenced ties  balance was the reason 
%-Status distinction 
...
\begin{figure}
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/circle-plus-triangle.png}
            \caption{Circle Graph with Closure}
            \label{fig:circleplus}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/circle-plus-long.png}
