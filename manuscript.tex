...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Comparison of betweenness brokerage and a structural fold goes here}
\end{figure}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/regular-edge.png}
            ...
            \label{fig:sf}
    \end{subfigure} 
    \caption{Comparison of kite graphs with varying parameters}
\end{figure}
