...
\begin{figure}
    ...
    \end{subfigure} \\
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/start-triangle1.png}
            \caption{Star Graph with Near Neighbor Closure}
            \label{fig:startriangle1}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/start-triangle2.png}
...
\begin{figure}
    ...
    \end{subfigure}
    \label{fig:struct-folds}
    \caption{Examples of varying degrees of connectedness within welded subgraphs. Distinction Centrality in toy graphs. Nodes with the highest distinction are shown in red, nodes with positive distinction are shown in blue, nodes with negative distinction are shown in tan, and nodes with distinction close to zero are shown in purple.}
\end{figure}
