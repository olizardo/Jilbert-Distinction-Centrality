...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.23\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/wheel-clique-edge-star.png}
            ...
            \label{fig:kite-connects-highest}
    \end{subfigure} 
    \begin{subfigure}[b]{0.23\textwidth}
    ...
    \centering
     \begin{subfigure}[b]{1.0\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/PortfolioIntegration.png}
            ...
            \label{fig:medici-integration-subfigure}
    \end{subfigure} \\
    \caption{}
