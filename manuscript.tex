...
Note also that because $\kappa_i = 0$, in terms of equation~\ref{eq:distinction} the star node's distinction score thus reduces to:
...
\begin{figure}
    ...
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/path.png}
            \caption{Path Graph}
            \label{fig:path}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/7-clique-plus-pendant.png}
            \caption{Clique Graph plus Pendant}
            \label{fig:circle-plus-pendant}
    \end{subfigure}
    \begin{subfigure}[b]{0.3\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/circular-lattice-plus-pendant.png}
...
\begin{figure}
    ...
    \end{subfigure} 
    \begin{subfigure}[b]{0.44\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/tree-mediator-three-branch.png}
...
\begin{figure}
    ...
    \centering
     \begin{subfigure}[b]{1.0\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/medici-full.png}
            \caption{Medici Network}
            \label{fig:medici-net}
    \end{subfigure} \\
     \begin{subfigure}[b]{1.0\textwidth}
        \includegraphics[width=1.0\textwidth]{Plots/Toys/medici-removed.png}
