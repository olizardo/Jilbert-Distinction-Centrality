...
\begin{figure}
    ...
    \end{subfigure}  
    \caption{Comparison of betweenness brokerage and structural folds Distinction Centrality in toy graphs. Nodes are colored by their scaled distinction scores on a continuous gradient from blue (highly constrained/negative distinction) through light gray (neutral) to red (high structural distinction).}
\end{figure}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Comparison of betweenness brokerage and a structural folds Distinction Centrality in toy graphs. Nodes are colored by their scaled distinction scores on a continuous gradient from blue (highly constrained/negative distinction) through light gray (neutral) to red (high structural distinction).}
\end{figure}
