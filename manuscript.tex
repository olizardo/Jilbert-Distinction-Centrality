...
Which tells us that the distinction of the peripheral node in the star graph is proportional to its own (scale) status, discounted by the distinction of the star node divided by the same scaling factor. 
