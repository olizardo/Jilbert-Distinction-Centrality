...
```{r Basic Toy Graphs}
   ...
   tab.cent(distinction(s7), name = "star", label = "star",
   ...
   tab.cent(distinction(k7), name = "kite", label = "kite",
   ...
   tab.cent(distinction(w7), name = "wheel", label = "wheel",
   ...
   source(here("Functions", "tab.cent.R"))
   tab.cent(distinction(p7), name = "path", label = "path",
...
```{r Mediator versus Weld}
   ...
   tab.cent(distinction(sf4), name = "structfold4", label = "sf4", 
   ...
   tab.cent(distinction(sf5), name = "structfold5", label = "sf5",
   ...
   tab.cent(distinction(sf5), name = "broker3", label = "b3", 
   ...
   tab.cent(distinction(b4), name = "broker4", label = "b4", 
